...
var palavraDaJogada = []; //array com a palavra da jogada, cada elemento do array uma letra -escrita normal e com acentos
var tentativas = [];
var letrasPalavraSecreta = []; // contem todas as letras da palavra secreta, maiusculas e sem acentos
var todasLetras; // um array com todas as divs das letras
var letrasErradas;
var letrasPreenchidas = 0;
var statusJogo
...
function escolherPalavraSecreta(){
    ...
    return nomesFilmes[indicePalavra] /**O array é o que estiver escolhendo as palavras// alterar para poder inserir o array como parâmetro */
}
...
function tirarAcentoEdeixarMaiuscula(palavra){
    return palavra.toUpperCase().normalize('NFD').replace(/[\u0300-\u036f]/,"")
}
...
function prepararJogo(){
    ...
    todasLetras.forEach(function(elemento){
         ...
         }else if(elemento.textContent == ':' || elemento.textContent == '-' || elemento.textContent == '!' || elemento.textContent == '?'){
        ...
        if (evento.key == 'Enter') {
            ...
            todasLetras.forEach(function (e) {
                ...
                if(tentativas.indexOf(letraSugestao) == -1){
                    ...
                    console.log(`A letra ${letraSugestao} já foi testada.. tente novamente!!!`);
                    input.value = '';
                }
